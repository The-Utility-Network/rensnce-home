...
export const alt = 'Ledger1 - Neuromimetic Business Architecture';
...
export default async function Image() {
    ...
    const medallionData = readFileSync(join(process.cwd(), 'public', 'Medallions', 'Ledger1_opt.png'));
                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: '10' }}>
                        ...
                        <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${THEME}`, paddingLeft: 30 }}>
                            ...
                            <span style={{ fontSize: 24, color: THEME, letterSpacing: '0.15em', fontWeight: 700, textShadow: '0 2px 10px black' }}>theutilitycompany.co/ledger1</span>
                        </div>
                    </div>
                </div>
