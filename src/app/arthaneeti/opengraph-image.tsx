...
export const alt = 'Arthaneeti - Democratizing Political Participation';
...
export default async function Image() {
    const bgData = readFileSync(join(process.cwd(), 'public', 'og-images', 'arthaneeti_og.jpg'));
        ...
        (
            <div style={{
                ...
                <div style={{
                    ...
                    background: 'rgba(255,255,255,0.1)' // Fallback for glass
                }}>
                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: '10' }}>
                        ...
                        <div style={{ marginTop: 20, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${THEME}`, paddingLeft: 30 }}>
                            ...
                            <span style={{ fontSize: 24, color: THEME, letterSpacing: '0.15em', fontWeight: 700, textShadow: '0 2px 10px black' }}>theutilitycompany.co/arthaneeti</span>
                        </div>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    background: 'rgba(255,255,255,0.05)' // Fallback for glass
                }}>
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                </div>
