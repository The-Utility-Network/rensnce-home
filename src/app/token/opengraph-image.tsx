...
export const alt = 'MKVLI Token - Governance & Utility';
export const size = { width: 2400, height: 1260 };
export const contentType = 'image/png';

const primaryColor = '#E5E4E2'; // Platinum theme

export default async function Image() {
    // Assets
    const bgData = readFileSync(join(process.cwd(), 'public', 'rensnce_hero_bg.png'));
    const bgBase64 = `data:image/jpeg;base64,${bgData.toString('base64')}`;

    // Using MKVLI medallion from Medallions folder
    const medallionData = readFileSync(join(process.cwd(), 'public', 'Medallions', 'MKVLI_opt.png'));
    ...
    return new ImageResponse(
        (
            <div style={{
                ...
                {/* 1. Base Background with Object Fit */}
                <img src={bgBase64} alt="Background" width={2400} height={1260} style={{
                    position: 'absolute',
                    inset: 0,
                    width: '100%',
                    height: '100%',
                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-end', zIndex: '10' }}>
                        <div style={{ fontSize: 32, fontWeight: 700, color: 'white', lineHeight: 1.2, textAlign: 'right', textShadow: '0 4px 30px rgba(0,0,0,0.9)' }}>
                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', display: 'flex', flexDirection: 'column', alignItems: 'flex-start', zIndex: '10' }}>
                        <div style={{ fontSize: 44, color: 'white', fontWeight: 300, lineHeight: 1.2, display: 'flex', flexDirection: 'column', maxWidth: 500, textShadow: '0 4px 30px rgba(0,0,0,0.9)' }}>
                            <span>MKVLI Token</span>
                            <span>Governance & Utility</span>
                        </div>
                        <div style={{ marginTop: 40, display: 'flex', flexDirection: 'column', gap: 12, borderLeft: `6px solid ${primaryColor}`, paddingLeft: 30 }}>
                            <span style={{ fontSize: 24, color: '#D1D5DB', letterSpacing: '0.15em', fontWeight: 500, textShadow: '0 2px 10px black' }}>EST. 2024</span>
                            <span style={{ fontSize: 24, color: primaryColor, letterSpacing: '0.15em', fontWeight: 700, textShadow: '0 2px 10px black' }}>rensnce.com/token</span>
                        </div>
                    </div>
                </div>
                ...
                <div style={{ position: 'absolute', left: 40, top: 40, width: 2320, height: 40, overflow: 'hidden', borderRadius: '24px 24px 0 0', display: 'flex', zIndex: '5', boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -40, objectFit: 'cover', objectPosition: 'top', filter: 'blur(6px)', transform: 'scale(1.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                ...
                <div style={{ position: 'absolute', left: 40, top: 1180, width: 2320, height: 40, overflow: 'hidden', borderRadius: '0 0 24px 24px', display: 'flex', zIndex: '5', boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -1180, objectFit: 'cover', objectPosition: 'top', filter: 'blur(6px)', transform: 'scale(1.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                ...
                <div style={{ position: 'absolute', left: 40, top: 80, width: 40, height: 1100, overflow: 'hidden', display: 'flex', zIndex: '5', boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -40, top: -80, objectFit: 'cover', objectPosition: 'top', filter: 'blur(6px)', transform: 'scale(1.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                ...
                <div style={{ position: 'absolute', left: 2320, top: 80, width: 40, height: 1100, overflow: 'hidden', display: 'flex', zIndex: '5', boxShadow: 'inset 0 0 10px rgba(255,255,255,0.2)' }}>
                    <img src={bgBase64} width={2400} height={1260} style={{ position: 'absolute', left: -2320, top: -80, objectFit: 'cover', objectPosition: 'top', filter: 'blur(6px)', transform: 'scale(1.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, background: 'rgba(255,255,255,0.05)' }} />
                    <div style={{ position: 'absolute', inset: 0, border: '2px solid rgba(255,255,255,0.3)', borderTop: 'none', borderBottom: 'none' }} />
                </div>
